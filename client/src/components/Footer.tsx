        ...
        <Box
            ...
            <Container as={Stack} maxW={'5xl'} py={10}>
                <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={"15px"}>
                    <Stack align={'flex-start'}>
                        <ListHeader>Приложение</ListHeader>
                        ...
                        <Link href={'#'}>Туториолы</Link>
                        <Link href={'#'}>Pricing</Link>
                        <Link href={'#'}>Выпуск</Link>
                    </Stack>
                    <Stack align={'flex-start'}>
                    ...
                    <Stack align={'flex-start'}>
                        <ListHeader>Легальность</ListHeader>
                        <Link href={'#'}>Cookies ограничения</Link>
                        <Link href={'#'}>Закон конфеденциальности</Link>
                        <Link href={'#'}>Термины сервиса</Link>
                        <Link href={'#'}>Закон</Link>
                        <Link href={'#'}>Статус</Link>
                    </Stack>
                    <Stack align={'flex-start'}>
                        <ListHeader>Мы в сети</ListHeader>
            ...
            <Box py={10}>
                ...
                <Text pt={6} fontSize={'sm'} textAlign={'center'}>
                    © 2022 Inter Planet Posts about Sport. Все права защищены
                </Text>
            </Box>
        </Box>
    );
